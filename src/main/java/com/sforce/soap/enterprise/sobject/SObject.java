...
public class SObject implements com.sforce.ws.bind.XMLizable {
	 ...
	 */
	private static final com.sforce.ws.bind.TypeInfo fieldsToNull__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:sobject.enterprise.soap.sforce.com", "fieldsToNull",
	...
	/**
	 * * element : Id of type {urn:enterprise.soap.sforce.com}ID * java type:
	 * java.lang.String
	 */
	private static final com.sforce.ws.bind.TypeInfo Id__typeInfo = new com.sforce.ws.bind.TypeInfo(
			"urn:sobject.enterprise.soap.sforce.com", "Id",
			"urn:enterprise.soap.sforce.com", "ID", 1, 1, true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
			com.sforce.ws.bind.TypeMapper __typeMapper)
			throws java.io.IOException {
		__typeMapper.writeObject(__out, fieldsToNull__typeInfo, fieldsToNull,
				fieldsToNull__is_set);
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
		...
		if (__typeMapper.isElement(__in, fieldsToNull__typeInfo)) {
			setFieldsToNull((java.lang.String[]) __typeMapper.readObject(__in,
					fieldsToNull__typeInfo, java.lang.String[].class));
		}
		__in.peekTag();
